#!/usr/bin/env python3
"""Diagnostic rocprof capture for Stage 7A phase-compact chunk-o."""
...
KERNELS = {
    ...
    "phase_compact": "_qwen_gdn_chunk_o_bf16_vnew_bf16_out_kernel_bt64_stage7a_phase_compact",
}
...
def main() -> None:
    ...
    command = [
        ...
        f"stage7a_{args.implementation}_T{args.T}", "-f", "csv", "--", sys.executable,
        str(HERE / "bench_qwen_gdn_bt64_native_chunko_stage7a_phase_compact.py"),
        "--implementation", args.implementation, "--T", str(args.T),
    ...
    out = args.out_dir / f"stage7a_{args.implementation}_T{args.T}_rocprof.json"
