#!/usr/bin/env python3
"""Dynamic PMC capture for Z5B and Z7B same-source arms."""
...
KERNELS = {
    ...
    "z7b_generic": "_qwen_gdn_chunk_o_bf16_vnew_bf16_out_kernel_bt64_stage6z_z7b_dot_v2",
    "z7b_specialized": "_qwen_gdn_chunk_o_bf16_vnew_bf16_out_kernel_bt64_stage6z_z7b_dot_v2",
}
...
def main() -> None:
    ...
    command = [
        ...
        *PMCS,
        ...
        "--",
        sys.executable,
        str(HERE / "bench_qwen_gdn_bt64_stage6z_z7b_dot_v2.py"),
        "--T",
        str(args.T),
        "--sessions",
        "1",
