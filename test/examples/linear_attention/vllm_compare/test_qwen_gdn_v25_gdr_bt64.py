...
def test_v25_bt64_bv32_chunk_gdr_matches_torch_ref(t: int, with_initial_state: bool):
    k, w, u, g, initial_state = _make_inputs(t, with_initial_state, seed=25000 + t + int(with_initial_state))

    h_ref, vn_ref, fs_ref = qwen_gdn_chunk_gdr_torch_ref_bt64(
        k,
        w,
        u,
        g,
    ...
    h_new, vn_new, fs_new = qwen_gdn_chunk_gdr_avelang_v25_bt64_bv32_mfma_layout(
        k,
        w,
        u,
        g,
