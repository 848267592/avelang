"""Experimental v29 full chunk_gdr with compiler K-fragment rewrite.
...
@avelang.jit
def _qwen_gdn_fused_chunk_gdr_full_kfrag_rewrite_exp_bf16_kernel_v29_mfma32(
...
def qwen_gdn_fused_chunk_gdr_full_avelang_v29_mfma32(
    ...
    *,
    ...
    _maybe_dump_hsaco(launch, "_qwen_gdn_fused_chunk_gdr_full_kfrag_rewrite_exp_bf16_kernel_v29_mfma32")
    launch()
...
def _smoke_main() -> None:
    ...
    print(f"T={args.T} v29_kfrag_rewrite_exp_chunk_gdr_ms={latency:.6f}")
