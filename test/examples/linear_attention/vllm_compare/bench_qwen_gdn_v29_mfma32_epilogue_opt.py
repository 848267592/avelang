...
def main() -> None:
    ...
    parser.add_argument("--seed", type=int, default=292000)
    ...
    print("target=v29_epilogue_opt_pred_only,B=1,Hv=8,K=128,V=128,BT=64,BV=32,WG=128,num_warps=2")
    print("summary_table")
    ...
    for t in args.T:
        ...
        for variant in args.variants:
            ...
            def run_variant(v=variant):
                return qwen_gdn_pred_only_avelang_v29_mfma32_epilogue_opt(w, u, initial_state, variant=v)
