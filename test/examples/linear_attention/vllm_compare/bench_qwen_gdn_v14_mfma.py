...
def stage_breakdown(q, k, v, g, beta, initial_state, scale, warmup: int, repeat: int, *, version: str):
    ...
    if version == "v12":
        wu_fn = lambda: qwen_gdn_w_u_avelang_v6_standalone(
            k,
            v,
            g_cumsum,
            beta,
        ...
        gdr_fn = qwen_gdn_chunk_gdr_avelang_v12_mfma_layout
        chunk_o_fn = qwen_gdn_chunk_o_avelang_v12_mfma_layout
    elif version == "v14":
        wu_fn = lambda: qwen_gdn_w_u_avelang_v14_mfma_layout(k, v, g_cumsum, beta, a_solved, chunk_size=chunk)
        gdr_fn = qwen_gdn_chunk_gdr_avelang_v14_mfma_layout
        chunk_o_fn = qwen_gdn_chunk_o_avelang_v14_mfma_layout
    else:
...
def run_t(t: int, warmup: int, repeat: int):
    ...
    stages_v12 = stage_breakdown(q, k, v, g, beta, initial_state, scale, stage_warmup, stage_repeat, version="v12")
    ...
    result = {
        ...
        "v12_mfma_ms": v12_ms,
        "v14_mfma_ms": v14_ms,
        "w_u_speedup_v14_vs_v12": stages_v12["w_u"] / stages_v14["w_u"],
        "full_speedup_v14_vs_v12": v12_ms / v14_ms,
        "slowdown_v14_vs_vllm": v14_ms / vllm_ms,
        "v14_vs_v12_out_err": max_err(out_v14, out_v12),
        "v14_vs_v12_fs_err": max_err(fs_v14, fs_v12),
        "v14_vs_vllm_out_err": max_err(out_v14, out_vllm),
        "v14_vs_vllm_fs_err": max_err(fs_v14, fs_vllm),
        "stages_v12": stages_v12,
...
def main():
    ...
    for r in rows:
        ...
        print(
            ...
            f"v14={r['v14_mfma_ms']:.4f}ms full_speedup_v14_vs_v12={r['full_speedup_v14_vs_v12']:.4f} "
            f"w_u_speedup_v14_vs_v12={r['w_u_speedup_v14_vs_v12']:.4f} slowdown_v14_vs_vllm={r['slowdown_v14_vs_vllm']:.4f} "
            f"v14_w_u={s14['w_u']:.4f}ms v14_chunk_gdr={s14['chunk_gdr']:.4f}ms v14_chunk_o={s14['chunk_o']:.4f}ms "
            f"v12_w_u={s12['w_u']:.4f}ms v12_chunk_gdr={s12['chunk_gdr']:.4f}ms v12_chunk_o={s12['chunk_o']:.4f}ms "
            f"out_err_v12={r['v14_vs_v12_out_err']:.6g} fs_err_v12={r['v14_vs_v12_fs_err']:.6g}"
        )
