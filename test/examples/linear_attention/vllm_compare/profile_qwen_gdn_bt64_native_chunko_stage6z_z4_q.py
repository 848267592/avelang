#!/usr/bin/env python3
"""rocprofv3 capture for the fixed-Z2 and independent Z4 Q arms."""
...
KERNELS = {
    ...
    "z4a": "_qwen_gdn_chunk_o_bf16_vnew_bf16_out_kernel_bt64_stage6z_z4a_vector_q",
    "z4b": "_qwen_gdn_chunk_o_bf16_vnew_bf16_out_kernel_bt64_stage6z_z4b_partial_q_residency",
...
def main() -> None:
    ...
    command = [
        ...
        *PMCS,
        ...
        "--",
        sys.executable,
        str(HERE / "bench_qwen_gdn_bt64_native_chunko_stage6z_z4_q_ladder.py"),
        "--T",
        str(args.T),
        "--arm",
        args.arm,
