"""Correctness coverage for the precomputed-V-decay diagnostic control."""
...
REPRO = HERE / "repro_qwen_gdn_direct_k64_block_dot_bv32_precomputed_vdecay.py"
...
def test_direct_k64_block_dot_bv32_precomputed_vdecay(tokens: int) -> None:
    row = _run(tokens)
    print("precomputed_vdecay", tokens, row)
    assert row["finite"]
