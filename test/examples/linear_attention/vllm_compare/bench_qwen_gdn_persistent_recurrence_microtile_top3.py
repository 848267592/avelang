#!/usr/bin/env python3
"""Fresh-process R4-tail versus resource-gated native microtile top-3."""
...
IMPLEMENTATIONS: tuple[tuple[str, str | None], ...] = (
    ("r4_tail_issue", None),
    ("micro_w1_k2_tail_d0", "gfx942_bt64_bv32_microtile_experimental_w1_k2_tail_d0"),
    ("micro_w4_k2_lastuse_d0", "gfx942_bt64_bv32_microtile_experimental_w4_k2_lastuse_d0"),
    ("micro_w1_k1_lastuse_d0", "gfx942_bt64_bv32_microtile_experimental_w1_k1_lastuse_d0"),
)
