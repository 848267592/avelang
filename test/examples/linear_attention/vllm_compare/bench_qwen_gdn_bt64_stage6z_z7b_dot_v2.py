#!/usr/bin/env python3
"""Fresh-process paired body benchmark for Z5B, Z7B G/B and native WG256."""
...
K = 128
V = 128
ARMS = ("z5b", "z7b_generic", "z7b_specialized", "native")
...
def _launch(arm: str, tensors: tuple[torch.Tensor, ...], output: torch.Tensor) -> Callable[[], None]:
    ...
    if arm == "z7b_generic":
        return lambda: qwen_gdn_chunk_o_bt64_native_chunko_stage6z_z7b_dot_v2_launch_into(
            *tensors, output, lowering="generic"
        )
    if arm == "z7b_specialized":
        return lambda: qwen_gdn_chunk_o_bt64_native_chunko_stage6z_z7b_dot_v2_launch_into(
            *tensors, output, lowering="specialized"
        )
...
def _parent(args: argparse.Namespace) -> None:
    orders = [
        ("z5b", "z7b_generic", "z7b_specialized", "native"),
        ("native", "z7b_specialized", "z7b_generic", "z5b"),
        ("z7b_generic", "z5b", "native", "z7b_specialized"),
        ("z7b_specialized", "native", "z5b", "z7b_generic"),
        ("native", "z5b", "z7b_specialized", "z7b_generic"),
        ("z7b_generic", "z7b_specialized", "native", "z5b"),
        ("z5b", "native", "z7b_generic", "z7b_specialized"),
    ]
    ...
    paired = {}
    for arm in ("z7b_generic", "z7b_specialized"):
