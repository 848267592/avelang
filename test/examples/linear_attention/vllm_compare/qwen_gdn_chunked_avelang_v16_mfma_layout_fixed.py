"""Clean Qwen GDN v16 MFMA prototype for the Qwen3Next TP4 per-rank target.
...
v16 keeps the v14 standalone MFMA w_u path and v14 chunk_o MFMA path, and
adds a 2-wave cooperative chunk_gdr kernel.  Each 128-thread block owns the
same [BV,128] state tile as v14, but wave0 handles K 0:64 and wave1 handles
K 64:128 for pred/update work.
"""
