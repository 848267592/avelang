...
def test_v27_bt64_bv16_regstate_matches_torch_ref(t: int, with_initial_state: bool):
    k, w, u, g, initial_state = _make_inputs(t, with_initial_state, seed=27000 + t + int(with_initial_state))
    ...
    h_new, vn_new, fs_new = qwen_gdn_chunk_gdr_avelang_v27_bt64_bv16_regstate_mfma_layout(
        k,
        w,
        u,
        g,
