#!/usr/bin/env python3
"""R5 joint_v5 full recurrence using the shared R1 semantic kernel.
...
import repro_qwen_gdn_persistent_recurrence_r5_joint_v5 as joint_v5


BT = r1.BT
LOWERING = "gfx942_bt64_bv32_joint_v5"


def _set_r5_lowering() -> None:
...
def _make_launch(
    ...
    *,
    ...
    def launch() -> None:
        joint_v5._qwen_gdn_persistent_recurrence_r5_joint_v5_kernel[
...
def run_correctness_length(t: int, *, seed: int) -> dict[str, Any]:
    ...
    r2_actual = r2._run_kernel(k, w, u, g, initial_state)
    r1_actual = r1._run_kernel(k, w, u, g, initial_state)
    r3_actual = r3._run_kernel(k, w, u, g, initial_state)
    ...
    comparisons = {
        "r5_vs_r2": b0._compare(actual, r2_actual, label="r5_vs_r2"),
        "r5_vs_r1": b0._compare(actual, r1_actual, label="r5_vs_r1"),
        "r5_vs_r3": b0._compare(actual, r3_actual, label="r5_vs_r3"),
        "r5_vs_b0": b0._compare(actual, b0_actual, label="r5_vs_b0"),
        "r5_vs_p2": b0._compare(actual, microscope, label="r5_vs_p2_host_microscope"),
        "r5_vs_device_contract": b0._compare(actual, reference, label="r5_vs_device_contract"),
    }
...
def main() -> None:
    ...
    (args.out_dir / "r5_correctness.json").write_text(json.dumps(results, indent=2) + "\n")
    if args.json:
