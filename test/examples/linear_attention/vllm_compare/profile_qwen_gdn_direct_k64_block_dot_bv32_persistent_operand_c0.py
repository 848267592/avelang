#!/usr/bin/env python3
"""Preallocated rocprof target for C0 persistent full-block lowering."""
...
def main() -> None:
    ...
    parser.add_argument("--operand", choices=["typed_vector", "persistent_typed_block"], required=True)
