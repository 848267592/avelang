#!/usr/bin/env python3
"""Dispatch one preallocated R1 joint-recurrence body for rocprof collection."""
...
for entry in reversed(os.environ.get("AVELANG_R1_PYTHONPATH", "").split(os.pathsep)):
    if entry:
...
def main() -> None:
    ...
    launch, _, _, _ = r1.run_body(k, w, u, g, initial_state)
